...
Project6Sample.h and Project6Stretch.h and evaluated in the order it is
declared, so a diagram that disagrees with the
...
def main():
    ...
    values = read_constants('source/Project6Slots.h', 'source/Project6Sample.h',
                            'source/Project6Stretch.h', 'source/Project6Dsp.h')
    (columns, rows, count,
    ...
    text(draw, (48, 74),
         ...
         'source/Project6Dsp.h, Project6Slots.h, Project6Sample.h and '
         'Project6Stretch.h — re-run it when the routing changes.',
         f_small, fill=MUTED)
    text(draw, (48, 92),
