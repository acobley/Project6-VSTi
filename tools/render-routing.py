...
def main():
    ...
    draw.line((48, 100, W - 48, 100), fill=RULE, width=1)
    ...
    text(draw, (62, 118), 'ROW A, IN FULL — every row is the same', f_head)
    ...
    for r in range(1, rows):
        ...
        text(draw, (pad_x0 + 14, mid),
             'Row %s   —   %d pads  →  %d slot levels  →  Σ  →  Row %s level'
